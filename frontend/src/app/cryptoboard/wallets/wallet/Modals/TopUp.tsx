...
import { topupTransaction } from "@/app/redux/requests/transactions";
...
const TopUp = ({ closeModal }: { closeModal: () => void }) => {
  ...
  const errTransaction = useSelector(transactionError);
    ...
    <div>
      ...
      <form
        onSubmit={async (e: React.FormEvent) => {
          e.preventDefault();
          await dispatch(
            topupTransaction({ moneyAmount: Number(topupAmount) })
          );
          ...
          setTopup("");
          if (errTransaction) {
            toast.error(errTransaction);
          } else {
            toast.success("Topup is successfull!");
          }
        }}
